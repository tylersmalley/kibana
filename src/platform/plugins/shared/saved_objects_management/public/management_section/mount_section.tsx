...
const SavedObjectsEditionPage = lazy(() =>
  import('./saved_objects_edition_page.js').then(({ default: lazyModule }) => ({
    default: lazyModule.default,
  }))
);
const SavedObjectsTablePage = lazy(() =>
  import('./saved_objects_table_page.js').then(({ default: lazyModule }) => ({
    default: lazyModule.default,
  }))
);
