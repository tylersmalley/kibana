...
const LazyDocViewerTable = dynamic(
  () =>
    import('./components/doc_viewer_table/index.js').then(({ default: lazyModule }) => ({
      default: lazyModule.default,
    })),
  { fallback }
);
const LazySourceViewer = dynamic(
  () =>
    import('./components/doc_viewer_source/index.js').then(({ default: lazyModule }) => ({
      default: lazyModule.default,
    })),
  { fallback }
);
