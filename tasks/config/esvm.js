    ...
    tribe: {
      options: {
        ...
        nodes: [{
          ...
          http: { port: 9201 },
          node: { name: 'dev-01', data: true, master: true, max_local_storage_nodes: 3 }
        }, {
          cluster: { name: 'cluster-02' },
          http: { port: 9202 },
          node: { name: 'dev-02', data: true, master: true, max_local_storage_nodes: 3 }
        }, {
          cluster: { name: 'tribe-01' },
          http: { port: 9200 },
          node: { name: 'dev-03', max_local_storage_nodes: 3 },
          tribe: {
            c1: {
              cluster: {
                name: 'cluster-01'
