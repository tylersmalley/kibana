...
type CreateApi = IScopedClusterClient['asInternalUser']['create'];
type GetApi = IScopedClusterClient['asInternalUser']['get'];
type SearchApi = IScopedClusterClient['asInternalUser']['search'];
...
describe('RuleMigrationsDataMigrationClient', () => {
  ...
  describe('create', () => {
    ...
    test('should throw an error if an error occurs', async () => {
      (esClient.asInternalUser.create as unknown as jest.MockedFn<CreateApi>).mockRejectedValueOnce(
