...
export function createJestConfig({ kibanaDirectory, rootDir }) {
  ...
  return {
    ...
    moduleNameMapper: {
      ...
      '^@kbn/test/jest': `${kibanaDirectory}/packages/kbn-test/target/jest/utils/enzyme_helpers`,
      '^@kbn/test/jest': `${kibanaDirectory}/packages/kbn-test/target/jest/utils/find_test_subject`,
