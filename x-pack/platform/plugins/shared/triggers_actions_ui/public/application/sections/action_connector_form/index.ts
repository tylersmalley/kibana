...
export const CreateConnectorFlyout = suspendedComponentWithProps<CreateConnectorFlyoutProps>(
  lazy(() =>
    import('./create_connector_flyout/index.js').then(({ default: lazyModule }) => ({
...
export const EditConnectorFlyout = suspendedComponentWithProps<EditConnectorFlyoutProps>(
  lazy(() =>
    import('./edit_connector_flyout/index.js').then(({ default: lazyModule }) => ({
      default: lazyModule.default,
    }))
  )
);
export const ActionForm = suspendedComponentWithProps(
  lazy(() =>
    import('./action_form.js').then(({ default: lazyModule }) => ({
      default: lazyModule.default,
    }))
  )
);
...
export const ConnectorAddModal = suspendedComponentWithProps<ConnectorAddModalProps>(
  lazy(() =>
    import('./connector_add_modal.js').then(({ default: lazyModule }) => ({
      default: lazyModule.default,
    }))
  )
);
...
export const AddConnectorInline = suspendedComponentWithProps(
  lazy(() =>
    import('./connector_add_inline.js').then(({ default: lazyModule }) => ({
      default: lazyModule.default,
    }))
  )
);
